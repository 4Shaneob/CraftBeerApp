...
using MvcBeerApp.Models;

namespace MvcBeerApp.Controllers
{
    public class BreweriesController : Controller
    {
        private MvcBeerAppContext db = new MvcBeerAppContext();
        ...
        public ActionResult Create([Bind(Include = "BreweryID,BreweryName")] Brewery brewery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BreweryID,BreweryName")] Brewery brewery)
        {
            if (ModelState.IsValid)
            {
